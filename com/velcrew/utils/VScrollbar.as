package com.velcrew.utils
{
	...
	public class VScrollbar extends MovieClip
	{
		...
		public function VScrollbar(dragged:MovieClip, maskclip:MovieClip, ruler:MovieClip, background:MovieClip, hitarea:MovieClip, blurred:Boolean = false, yfactor:Number = 4 , autoRuler = false)
		{
			super();
			_dragged = dragged; 
			_mask = maskclip; 
		...
		private function clickHandle(e:MouseEvent) 
		{
			...
			var rect:Rectangle = new Rectangle(1, minY, 0, maxY);
		...
		public function positionContent():void {
			...
			if(_autoRuler)this._ruler.height = (this._ruler.height / this._dragged.height) * this._background.height;
			this.maxY = this._background.height - this._ruler.height;
			/*	*/ 		
			
			//trace(this._ruler.height, this._ruler.height,this._dragged.height, this._background.height);
